...
namespace Nomis.Xdcscan.Interfaces.Models
{
    ...
    public class XdcTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToXdc();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToXdc();
        ...
        public decimal AmountInSumValue => AmountInSum.ToXdc();
