...
namespace Nomis.CyberConnect
{
        ...
        ISingletonService
    {
        ...
        public async Task<Result<string?>> HandleAsync(CyberConnectHandleRequest request)
        {
            ...
            return await Result<string?>.SuccessAsync(null, "There is an error when getting handle by address.").ConfigureAwait(false);
        }
        ...
        public async Task<Result<CyberConnectProfileData?>> ProfileDataAsync(CyberConnectProfileRequest request)
        {
            ...
            return await Result<CyberConnectProfileData?>.SuccessAsync(null, "There is an error when getting profile by handle.").ConfigureAwait(false);
        }
