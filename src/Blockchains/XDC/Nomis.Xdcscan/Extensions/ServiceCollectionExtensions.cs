...
namespace Nomis.Xdcscan.Extensions
{
    /// <summary>
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        internal static IServiceCollection AddXdcscanService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<XdcscanSettings>(configuration);
            return services
                .AddTransient<IXdcscanClient, XdcscanClient>()
                .AddTransientInfrastructureService<IXdcScoringService, XdcscanService>();
        }
    }
}